...
public class ReminderHelper {
    ...
    public static long setReminder(Activity activity, Plant currentPlant) {
        // get calendar
        Calendar cal = Calendar.getInstance();
        cal.set(Calendar.HOUR_OF_DAY, currentPlant.wateringSchedule.hour);
        cal.set(Calendar.MINUTE, currentPlant.wateringSchedule.min);
        ...
        values.put(CalendarContract.Events.TITLE, "Your " + currentPlant.getName() + " gonna be drained. It's time to water it");
        ...
        values.put(CalendarContract.Events.RRULE, "FREQ=Weekly;" + getWeekDayAsString(currentPlant.wateringSchedule.dayOfWeek));
        values.put(CalendarContract.Events.DESCRIPTION, "Your " + currentPlant.getName() + " gonna be drained. It's time to water it");
